...
`GET https://<RadiantOneRESTEndpoint>/adap/util?action=vdsconfig&commandname=search-vds&dn=action=deltarefreshpcache,o=companyprofiles&scope=sub&filter=(objectclass=*)&leader`
