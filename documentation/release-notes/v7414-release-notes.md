...
- [VSTS47495]: Fixed a regression in v7.4.13 that caused certain unwanted LDAP controls to be forwarded to LDAP proxy backends during specific LDAP search requests.  
- [VSTS47487]: Fixed a regression where configuring the HTTP and HTTPS ports in the control panel's settings page was mistakenly altering the control panel's HTTP and HTTPS ports.
