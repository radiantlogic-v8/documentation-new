...
- For SaaS Identity Data Management environments, customers must [configure their promotion pipeline](../../documentation-eoc/documentation/promotion-pipelines/configuration-promotion.md) in the Environment Operations Center (EOC). Note that this feature is supported in EOC version 1.4.0 or higher. 
