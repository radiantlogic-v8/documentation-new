...
1. Enter values for the following properties. 
    ...
    Message Format | (The name of the changeEventConvertor, such as GoldenGateJSONConvertor)
...
In this section, a new naming context representing the outgoing Kafka Producer is added. If you plan to consume identity data to a Kafka topic, a separate view is required.
