...
# Docker
Radiant Logic provides preconfigured images of RadiantOne (version - 7.4) in Docker containers. Once deployed, the product is entirely operable. The containers are preconfigured to interoperate with other containers in the stack. 
