...
| **Logging – Log2DB** | No UI setting. Check logging configuration for database storage. | Migrate to fluentd/ElasticSearch. SaaS customers can view logs in Environment Operations Center. | SaaS: Supports fluentd/ElasticSearch; Self-managed Identity Data Management customers can [setup their own logging system](../../v8.1/installation/metrics-and-logging/). |
