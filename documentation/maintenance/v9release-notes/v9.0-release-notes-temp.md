...
- [V9-347, SQ-668, SQ-1943]: Added a performance improvement that makes ResyncUtil skip entries that were not modified after cluster disconnection, thus reducing the number of entries to process.
