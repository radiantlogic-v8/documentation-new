...
6. Enter a meaningful description and select a source attribute to display in the [*Approvals* portal](../../concepts-and-definitions/approvals/#performing-approvals) to help provide context for the approver about the synchronization event. 
