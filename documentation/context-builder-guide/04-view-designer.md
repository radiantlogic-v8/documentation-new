...
Figure 4.8: Virtual View Model and Runtime Tree using Standard Links
...
Figure 4.18: Three Example Data Sources
...
![An image showing ](Media/Image4.23.jpg)

Figure 4.23: Properties for a Link Node
...
![An image showing ](Media/Image4.24.jpg)
...
![An image showing ](Media/Image4.25.jpg)
...
For combining tables, see [Joins](02-concepts-and-utilities.md#joins-between-objects-of-the-same-schemasource) (this is only relevant for database backends). 
...
![An image showing ](Media/Image4.26.jpg)
...
![An image showing ](Media/Image4.27.jpg)
...
2.	Select the attribute that you want to expose in the virtual entries and use the ![An image showing ](Media/ImageRightArrow.jpg) button to move it over to the column on the right.

3.	To remove an attribute from the virtual entry definition, highlight the column name and click the ![An image showing ](Media/ImageRedX.jpg) button. 
...
![An image showing ](Media/Image4.28.jpg)
...
![An image showing ](Media/Image4.29.jpg)
...
![An image showing ](Media/Image4.30.jpg)

Figure 4.30: Filter for SQL-accessible Backend Dialog Box
...
![An image showing ](Media/Image4.31.jpg)
...
![An image showing ](Media/Image4.32.jpg)
...
![An image showing ](Media/Image4.33.jpg)
...
![An image showing ](Media/Image4.34.jpg)
...
![An image showing ](Media/Image4.35.jpg)
...
![An image showing ](Media/Image4.36.jpg)

Figure 4. 36: Stored Procedures Tab
...
![An image showing ](Media/Image4.38.jpg)

Figure 4.38: Sample LDAP Hierarchy
...
![An image showing ](Media/Image4.39.jpg)
...
![An image showing ](Media/Image4.40.jpg)
...
![An image showing ](Media/Image4.41.jpg)
...
![An image showing ](Media/Image4.42.jpg)
...
![An image showing ](Media/Image4.44.jpg)
...
![An image showing ](Media/Image4.45.jpg)
...
![An image showing ](Media/Image4.46.jpg)
...
Figure 4.47: Actualdn Attribute
...
![An image showing ](Media/Image4.50.jpg)
...
If you need help on defining recursive relationships for your database schema, please see the recursive relationships section in [Chapter 3](03-schema-manager.md). 

![An image showing ](Media/Image4.51.jpg)
...
It is assumed that the database schema has already been extracted (and all relationships defined). If you need help with this process, please see [Chapter 3](03-schema-manager.md) on the Schema Manager. The steps below describe the process using the default Northwind schema that is included with RadiantOne. 
...
![An image showing ](Media/Image4.52.jpg)
...
![An image showing ](Media/Image4.53.jpg)

Figure 4.53: Virtual View Model Based on Database Relationships
...
![An image showing ](Media/Image4.54.jpg)
...
![An image showing ](Media/Image4.55.jpg)
...
![An image showing ](Media/Image4.56.jpg)

Figure 4.56: Sample RadiantOne Entries Based on Database Objects

Using the example above, the following steps describe how to build a flat virtual view from a database schema. It is assumed that the database schema has already been extracted, and all needed relationships are defined. If you need assistance extracting a database schema, please see [Chapter 3](03-schema-manager.md). 
...
![An image showing ](Media/Image4.58.jpg)
...
The first step is to extract the database schema. If you need help with this process, see [Chapter 3](03-schema-manager.md). The figure below depicts an example of a database schema. 

![An image showing ](Media/Image4.59.jpg)
...
![An image showing ](Media/Image4.60.jpg)
...
![An image showing ](Media/Image4.61.jpg)
...
![An image showing ](Media/Image4.62.jpg)
...
><span style="color:red">**IMPORTANT NOTE – Do not use attribute mappings, computed attributes, or joins directly on the virtual view from the SCIM backend. Create a basic view with no attribute mappings, computed attributes or joins and then define the view with persistent cache. Initialize the persistent cache and then use Schema Manager and View Designer to point to the cached naming context in the RadiantOne namespace as an [LDAP backend](03-schema-manager.md#ldap-accessible-backend). Define the attribute mappings, computed attributes and joins on this virtual view.**

It is assumed that the SCIMv2 schema has already been extracted. If you need help with this process, please see [Chapter 3](03-schema-manager.md#ldap-accessible-backend) on the Schema Manager. The steps below describe the basic of creating a virtual view from a SCIMv2 backend. 
...
10.	Use the ![An image showing ](Media/ImageRightArrow.jpg) button to define some attributes in the virtual view.
...
14.	Use the ![An image showing ](Media/ImageRightArrow.jpg) button to define some attributes in the virtual view.
15.	Save the virtual view.  An example of the view definition and Runtime preview of a SCIMv2 backend is shown below.

![An image showing ](Media/Image4.63.jpg)
...
1.	On the View Designer menu, click ![An image showing ](Media/ImageDelete.jpg). 

2.	Select the virtual view file you want to remove and click OK. 
3.	Click Yes to confirm the deletion. 
 
 ![An image showing ](Media/Image4.64.jpg)
