...
encounter. This chapter provides a high-level overview of the RadiantOne administration consoles. The identity service wizards are also discussed along with guidance to help determine which will meet your needs.
...
Figure 5.1: Main Control Panel Login Page
...
Figure 5.2: The Overview section of the Main Control Panel’s Dashboard tab
...
Figure 5.3: Cluster Nodes Depicted in the Health Section
...
The Directory Namespace tab is where you can configure and manage root naming contexts and persistent cache. This tab is not accessible on [follower-only](06-high-availability-and-performance.md#follower-only-nodes) cluster nodes.
...
![An image showing ](Media/Imagerealtimerefresh.jpg) is the symbol for a real-time refresh.

![An image showing ](Media/ImagePeriodicRefresh.jpg) is the symbol for a periodic refresh.
...
For more information on user-defined and auto-generated groups please see the [Design Considerations](03-virtual-view-design.md#design-considerations) section of this guide.
...
Figure 5.4: Example of Merging Trees
...
Figure 5.5: Example of a Directory tree Comprised of an Aggregation of Three Sources
