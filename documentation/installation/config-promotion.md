...
Login to your self-managed Identity Data Management environment(s) and implement configuration changes by following the steps outlined in [this](../deployment/configuration-promotion.md) document.
