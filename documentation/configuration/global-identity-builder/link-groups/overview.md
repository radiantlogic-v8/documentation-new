...
This page describes how to virtualize existing static groups from backend directories and define the remapping needed so the group member DNs are remapped to the identities in the global profile. The process of creating a global profile of identities is described in the [concepts](../concepts.md), [project creation](../create-projects/create-project.md), [manual identity administration](../identity-administration.md), and [real-time persistent cache refresh](../manage-persistent-cache/overview.md) documents.
