...
2.	On the Special Attributes tab, locate the Unnest Groups section.  This option is only available if there is a persistent cache defined.
...
5.	Click **ADD**.
6.	Click **SAVE**.
7.	Reinitialize the [persistent cache](../../tuning/persistent-cache) for the identity view containing the nested groups from the Cache tab. 
