...
![Data Sources with No Overlapping Identities](Media/Image1.1.jpg)
...
![Data Sources with No Overlapping Identities](Media/Image1.2.jpg)
 
Figure 2: Data Sources with No Overlapping Identities
...
![Complex Identity Integration Scenario](Media/Image1.3.jpg)
 
Figure 3: Complex Identity Integration Scenario
...
There are two methods to use the Identity Data Analysis Tool. One is from command line, and the other is from the web-based interface.  The Identity Data Analysis web utility is described in [Using the Identity Data Analysis Web Interface](02-using-the-identity-data-analysis-web-interface.md) and the command line utility is described in [Using the Identity Data Analysis Command Line Tool](03-using-identity-data-analysis-command-line-tool.md).