...
3.	Select a secure data connector from the Connect with Agent drop-down menu. For information on secure data connector, see [secure data connector](concepts#secure-data-connector).
...
6.  Select a secure data connector from the Connect with Agent drop-down menu. For information on secure data connector, see [secure data connector](concepts#secure-data-connector).
...
>[!warning] 
>The idleTimeoutForLocalConnection property must always be greater than the [Global Idle Timeout](limits#idle-timeout), otherwise the Global Idle Timeout takes precedence for closing the internal connections as well as the external (client) connections.
