...
Figure 3.37: Administration Section
...
Figure 3.39: Supported Controls Section
...
Figure 3.40: Client Accessing RadiantOne using Paging
...
Figure 3. 37: Flowchart Depicting Behavior for Supporting VLV Control
...
Figure 3.42: Manually editing the ACI
...
Image 3.43: Authorization Identity Control
...
Figure 3.44: Who Am I extended request support
...
Figure 3.45: Attributes Handling Section
...
Figure 3.46: Duplicate Identity Handling Section
...
Figure 3.47: Virtual View Aggregating Two Data Sources

![An image showing ](Media/Image3.48.jpg)
 
Figure 3.48: Same user ID Exists in Multiple Data Sources that have been Aggregated by RadiantOne
...
Figure 3.49: Duplicate DN Removal Setting

![An image showing ](Media/Image3.50.jpg)
 
Figure 3.50: Search Result after Enabling Duplicate DN Removal
...
Figure 3.51: Result of Duplicate DN Removal
...
Figure 3.52: Virtual Entry from Active Directory Backend

![An image showing ](Media/Image3.53.jpg)
 
Figure 3.53: Virtual Entry from Sun Directory Backend
...
Figure 3.54: Two Entries are Returned based on Filter of EmployeeID=8
...
Figure 3.55: Duplicate Identity Removal Settings
...
Figure 3.56: One Entry for Laura is Returned with Duplicate Identity Removal Rules Enabled
...
Figure 3.57: Memory Cache Settings
...
Figure 3.58: Other Protocols Section
...
Figure 3.60: Custom RootDSE Settings
