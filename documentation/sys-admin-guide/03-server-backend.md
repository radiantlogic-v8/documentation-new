...
Figure 3.61: Connection Pooling Settings
...
Figure 3.63: Adding a New LDAP Data Source
...
Figure 3.64: Configuration for RadiantOne to Connect to the Underlying LDAP Server via STARTTLS
...
Figure 3.65: Enabling Mutual Authentication Between RadiantOne and the Underlying LDAP Server
...
Figure 3.66: RadiantOne Acting as a Kerberos Client – Note the client accessing RadiantOne is NOT portrayed in this Diagram
...
Figure 3.67: Kerberos Profile Settings
...
Figure 3.68: Sample LDAP Data Source Using Kerberos
...
To update the connection information associated with a data source, select the configured data source and click **Edit**. After editing the information, click on the test connection button and then save the updated information.
...
Figure 3.69: Impersonation Rules
...
Figure 3.70: Virtual View with Role Mapped Access Enabled
...
Figure 3.70: Indicating a Default User Account
...
Figure 3.72: Database Data Sources
...
Figure 3. 66: Sample Custom Data Source
...
Figure 3.74: Sample Custom DSML/SPML Data Source
...
Figure 3.75: Sample Custom SCIM v2 Data Source
...
Figure 3.76: The Test Connection URL Property
...
Figure 3.78: Disabling SCIM Backend Exception Parameters
...
Figure 3.79: Internal Connection to RadiantOne
...
Figure 3.80: Persistent Cache Initialization Location
