...
*   Look for the application **Dropbox for Business**
*   Click **Configure**.

![](media/dropbox-configure.png)
...
![](media/dropbox-tab-mappings.png)
...
![](media/dropbox-tab-access-rules.png)
...
![](media/dropbox-tab-certificate.png)
