---
title: CFS
description: Configuring SSO for Citrix GoToWebinar with CFS
---
...
*   Look for the application **Citrix GoToWebinar**
*   Click **Configure**.

![](media/gotowebinar-configure.png)
...
![](media/gotowebinar-tab-general.png)
...
![](media/gotowebinar-tab-parameters.png)
...
![](media/gotowebinar-tab-mappings.png)
...
![](media/gotowebinar-tab-filter.png)
...
![](media/gotowebinar-tab-certificate.png)
