---
title: CFS
description: Configuring SSO for Jive with CFS
---
...
*   Look for the application **Jive**
*   Click **Configure**.

![](media/jive-configure.png)
...
*   **Application Address** - Enter the address of the application.

![](media/jive-tab-parameters.png)
...
![](media/jive-tab-certificate.png)
