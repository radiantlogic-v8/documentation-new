...
*   Look for the application **WS-Federation Generic**
*   Click **Configure**.

![](media/wsfed-generic-configure.png)
...
![](media/wsfed-generic-tab-general.png)

### Parameters

The **Parameters** tab contains the list of settings required to configure the application.

*   **Realm** - Enter the WS-Federation parameter Realm.
*   **Context** - Enter the WS-Federation parameter Context.
*   **Reply** - Enter the WS-Federation parameter Reply.

![](media/wsfed-generic-tab-parameters.png)
...
![](media/wsfed-generic-tab-mappings.png)
...
![]media/wsfed-generic-tab-access-rules.png)
...
![](media/wsfed-generic-tab-filter.png)
...
![](media/wsfed-generic-tab-certificate.png)