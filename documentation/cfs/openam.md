---
title: CFS
description: Configuring SSO for OpenAM with CFS
---
...
*   Look for the application **OpenAM**
*   Click **Configure**.

![](media/openam-configure.png)
...
![](media/openam-tab-parameters.png)
...
![](media/openam-tab-certificate.png)
