---
title: CFS
description: Configuring SSO for the DocuSign QA environment with CFS
---
...
*   Look for the application **DocuSign - QA**
*   Click **Configure**.

![](media/docusign-qa-configure.png)
...
![](media/docusign-qa-tab-general.png)
...
![](media/docusign-qa-tab-mappings.png)
...
![](media/docusign-qa-tab-filter.png)
...
![](media/docusign-qa-tab-certificate.png)
