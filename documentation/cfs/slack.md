...
*   Look for the application **Slack**
*   Click **Configure**.

![](media/slack-configure.png)
...
![](media/slack-tab-general.png)

### Parameters

The **Parameters** tab contains the list of settings required to configure the application.

*   **Slack Team URL** - Enter your Slack Team name in your login URL. E.g. with [https://<TeamURL>.slack.com](https://<TeamURL>.slack.com) enter the value TeamURL

![](media/slack-tab-parameters.png)
...
![](media/slack-tab-access-rules.png)
...
![](media/slack-tab-certificate.png)

Configuring Slack
-----------------

To configure Slack, visit [https://get.slack.help/hc/en-us/articles/203772216-Using-single-sign-on-with-Slack](https://get.slack.help/hc/en-us/articles/203772216-Using-single-sign-on-with-Slack)