---
title: CFS
description: Configuring SSO for NetScaler with CFS
---
...
*   Look for the application **NetScaler**
*   Click **Configure**.

![](media/netscaler-configure.png)
...
![](media/netscaler-tab-general.png)
...
*   **NetScaler Server FQDN** - Enter the FQDN of the NetScaler machine.

![](media/netscaler-tab-parameters.png)
...
![](media/netscaler-tab-mappings.png)
...
![](media/netscaler-tab-filter.png)
...
![](media/netscaler-tab-certificate.png)
