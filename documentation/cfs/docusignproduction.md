...
*   Look for the application **DocuSign - Production**
*   Click **Configure**.

![](media/docusign-prod-configure.png)
...
![](media/docusign-prod-tab-general.png)
...
![](media/docusign-prod-tab-mappings.png)
...
![](media/docusign-prod-tab-access-rules.png)
...
![](media/docusign-prod-tab-filter.png)
...
![](media/docusign-prod-tab-certificate.png)