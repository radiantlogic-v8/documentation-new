---
title: CFS
description: Configuring SSO for Citrix GoToTraining with CFS
---
...
*   Look for the application **Citrix GoToTraining**
*   Click **Configure**.

![](media/gototraining-configure.png)
...
![](media/gototraining-tab-general.png)
...
![](media/gototraining-tab-parameters.png)
...
![](media/gototraining-tab-mappings.png)
...
![](media/gototraining-tab-filter.png)
...
![](media/gototraining-tab-certificate.png)
