---
title: CFS
description: Configuring Microsoft AD FS as a WS-Federation identity provider in CFS
---
...
The **Filter** tab is another security layer that allows to filter the access to the application by using the context of the user. This context is based on the attributes of the user retrieved from the RadiantOne identity store and the attributes generated by CFS like the [Circle of Trust](02-getting-startedl#circle-of-trust).
