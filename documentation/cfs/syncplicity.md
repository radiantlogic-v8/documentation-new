---
title: CFS
description: Configuring SSO for Syncplicity with CFS
---
...
![](media/syncplicity-tab-general.png)

### Parameters

The **Parameters** tab contains the list of settings required to configure the application.

*   **Sub Domain** - Enter the sub domain name created on Syncplicity.

![](media/syncplicity-tab-parameters.png)
...
![](media/syncplicity-tab-mappings.png)
...
![](media/syncplicity-tab-filter.png)
...
![](media/syncplicity-tab-certificate.png)
