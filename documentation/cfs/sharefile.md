---
title: CFS
description: Configuring SSO for ShareFile with CFS
---
...
*   Look for the application **ShareFile**
*   Click **Configure**.

![](media/sharefile-configure.png)
...
![](media/sharefile-tab-general.png)
...
![](media/sharefile-tab-parameters.png)
...
![](media/sharefile-tab-mappings.png)
...
![](media/sharefile-tab-filter.png)
...
![](media/sharefile-tab-certificate.png)
...
ENter the required settings to configure the SSO.

*   Check the option **Enable SAML**.
*   Leave the **ShareFile Issuer** value as it is provided.
*   Enter the **IDP Issuer** based on the value you've provided in the CFS configuration page for the application.
*   Provide the [**certificate**](#certificate) used for this application.
*   The **Login URL** is provided at the end of the metadata file. e.g. `https://CFS_ADDRESS/cfs/Saml2/radiantlogic/APPLICATION_GUID`
*   The **Logout URL** is the same as the Login URL.
*   Leave the other parameters.

![](media/sharefile-2-configuration.png)
