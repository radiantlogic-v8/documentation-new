...
*   Look for the application **Workplace by Facebook**
*   Click **Configure**.

![](media/facebook-configure.png)
...
![](media/facebook-tab-general.png)
...
*   **Sub Domain** - Enter the sub domain you've choosed on Facebook.
*   **Company Id** - Enter the identifier of your company provided by Facebook.

![](media/facebook-tab-parameters.png)
...
![](media/facebook-tab-mappings.png)
...
![](media/facebook-tab-access-rules.png)
...
![](media/facebook-tab-certificate.png)