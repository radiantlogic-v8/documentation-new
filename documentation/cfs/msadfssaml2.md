...
*   Look for the application **Microsoft AD FS as SAML 2**
*   Click **Configure**.

![](media/microsoftadfs-saml2-configure.png)
...
![](media/microsoftadfs-saml2-tab-general.png)

### Parameters

The **Parameters** tab contains the list of settings required to configure the application.

*   **Issuer** - Enter the identifier you want to use for CFS. (e.g. radiantlogic)
*   **Machine Name** - Enter the FQDN of the ADFS machine.

![](media/microsoftadfs-saml2-tab-parameters.png)
...
![](media/microsoftadfs-saml2-tab-mappings.png)
...
![](media/microsoftadfs-saml2-tab-access-rules.png)
...
![](media/microsoftadfs-saml2-tab-filter.png)
...
![](media/microsoftadfs-saml2-tab-certificate.png)
