---
title: CFS
description: Configuring SSO for GitLab with CFS
---
...
![](media/gitlab-tab-general.png)

### Parameters

The **Parameters** tab contains the list of settings required to configure the application.

*   **Server FQDN** - FQDN of the GitLab server.

![](media/gitlab-tab-parameters.png)
...
![](media/gitlab-tab-certificate.png)

Configure GitLab
----------------

Follow this [online documentation](https://docs.gitlab.com/ce/integration/saml.html) to configure GitLab for SAML 2.0.
