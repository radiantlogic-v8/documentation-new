...
9. On the Client Credential page, click **Edit*.

10. Copy the value for the Client ID. This is used when you configure Okta as the Identity Provider in the Control Panel. 

11. Enable the option *Require PKCE as additional verification*.
