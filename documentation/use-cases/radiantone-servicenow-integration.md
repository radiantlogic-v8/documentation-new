...
![image of service now roles UI](Media/servicenow-roles.png)
...
![image showing connection fields for data source](Media/connectioninfo.png)
...
![image showing data source creation](Media/dscreate.png)
...
![image showing data source creation](Media/dscreated.png)
...
![image showing schema extraction - step 1](Media/extractschema-1.png)

b. Click on the ’SCHEMA’ tab at the top of the Data Source page. 

![image showing schema extraction - step 2](Media/extractschema-2.png)
...
![image showing schema extraction - step 3](Media/extractschema-3.png)
...
![image showing schema extraction - step 4](Media/extractschema-4.png) 
...
![image showing schema extraction - step 5](Media/extractschema-5.png) 

f. The selected objects should show in the bottom pane.  After selecting your desired schema elements, click ‘EXTRACT’.  

![image showing schema extraction - step 6](Media/extractschema-6.png) 
...
![image showing schema extraction - step 7](Media/extractschema-7.png) 
...
![image showing schema extraction - step 8](Media/extractschema-8.png) 
...
![image showing namespace creation - step 1](Media/namespacecreation-1.png) 
...
![image showing namespace creation - step 2](Media/namespacecreation-2.png) 
...
![image showing namespace creation - step 3](Media/namespacecreation-3.png) 

d. At the root level that was just created, select and then click ‘MOUNT BACKEND’.  

![image showing namespace creation - step 4](Media/namespacecreation-4.png) 

e. Click on the ‘Virtual Tree’ option, then click on ’SELECT’. 

![image showing namespace creation - step 5](Media/namespacecreation-5.png) 
...
![image showing namespace creation - step 6](Media/namespacecreation-6.png) 
...
![image showing namespace creation - step 7](Media/namespacecreation-7.png) 
...
![image showing namespace creation - step 9](Media/namespacecreation-11.png) 
...
![image showing cache creation - step 1](Media/cache1.png) 

Next, click the "Create new cache" button. 

![image showing cache creation - step 2](Media/cache2.png) 
...
![image showing cache creation - step 3](Media/cache3.png) 
...
![image showing cache creation - step 4](Media/cache4.png) 

d. Click ‘INITIALIZE’. 

![image showing cache creation - step 5](Media/cache5.png) 
...
![image showing cache creation - step 6](Media/cache6.png) 
...
![image showing cache creation - step 7](Media/cache7.png) 

f. Click ‘SAVE’ to finalize the operation after the Cache has been successfully created. 

![image showing cache creation - step 7](Media/cache8.png) 

After successful creation, the status of the cache shows "Active".

![image showing cache creation - step 7](Media/cache9.png) 
...
![image showing directory browser - step 1](Media/review-1.png) 

b. Click on the arrow next to the Namespace that was previously created.

![image showing directory browser - step 1](Media/review-2.png) 
...
![image showing directory browser - step 1](Media/review-3.png) 
...
![image showing Postman example](Media/example-2.png) 
