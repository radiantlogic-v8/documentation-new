...
<section>
<connector name="SailPoint Identity Security Cloud Connector" eyebrow="Identity" meta="v1.0.0 · Connector SDK 1.2.0 · IDDM 8.4.0+" href="/connectors/sailpoint" capabilities="identity,writeback" objects="Accounts,Access Profiles,Identities,Roles,Entitlements,Sources">Virtualizes SailPoint ISC identity and access objects via SailPoint's REST APIs.</connector>
<connector name="CyberArk Privilege Cloud Connector" eyebrow="Privileged Access" meta="v2.0.0 · Connector SDK 1.1.0 · IDDM 8.3.0+" href="/connectors/cyberark" capabilities="identity,writeback,observability" objects="Identities,Roles,Safes,Accounts,Directory Services">Integrates with CyberArk Privilege Cloud and Identity Services to retrieve and manage Users, Roles, Safes, Accounts, and Directory Services.</connector>
<connector name="AWS Identity Center Connector" eyebrow="Cloud Identity" meta="v1.0.0 · Connector SDK 1.0.0 · IDDM 8.2.1+" href="/connectors/aws-identity-center" capabilities="identity,readonly,observability" objects="Identities,Groups,Group Memberships,Permission Sets,Accounts">Virtualizes AWS Identity Center users, groups, permission sets, and AWS accounts for compliance and reporting.</connector>
<connector name="GCP Pub/Sub Connector" eyebrow="Eventing" meta="v1.0.0 · Connector SDK 1.1.1 · IDDM 8.3.1+" href="/connectors/gcp-pubsub" capabilities="signal,writeback,unstructured" objects="Messages">Bidirectional bridge between Google Cloud Pub/Sub and RadiantOne. Exposes Pub/Sub messages as LDAP entries (read) and publishes LDAP write operations as JSON messages to a Pub/Sub topic.</connector>
</section>
